    ...
    public static class TrackParser
    {
        ...
        public static TrackInfo GetTrackInfo(string artists, string title, string albumArtists, string album, DateTime date)
        {
            var info = new TrackInfo
            {
                ...
                Album = album,
                AlbumArtists = SplitArtists(albumArtists),
            ...
            {
                int index;
                while ((index = track.IndexOf("(", COMPARISON_TYPE)) >= 0)
                {
                        ...
                        string.Equals(track.Substring(index + 1, FEAT.Length), FEAT, COMPARISON_TYPE))
                    {
                        var featuresText = track.Substring(index + FEAT.Length + 1, endIndex - index - FEAT.Length - 1)
                            .Trim();
                        info.Features.AddRange(SplitArtists(featuresText));
                             ...
                             string.Equals(track.Substring(index + 1, PROD.Length), PROD, COMPARISON_TYPE))
                    {
                        ...
                        track = track.Remove(index, endIndex - index + 1).Trim();
                             ...
                             string.Equals(track.Substring(index + 1, endIndex - index - 1), EXTENDED_MIX, COMPARISON_TYPE))
                    {
                        track = track.Remove(index, endIndex - index + 1).Trim();
                    }
                    else if (index + 1 + EXTENDED_EDIT.Length < track.Length &&
                             string.Equals(track.Substring(index + 1, endIndex - index - 1), EXTENDED_EDIT, COMPARISON_TYPE))
                    {
                        track = track.Remove(index, endIndex - index + 1).Trim();
                    }
                                 ...
                                 COMPARISON_TYPE))
                    {
                        track = track.Remove(index, endIndex - index + 1).Trim();
                             ...
                             string.Equals(track.Substring(index + 1, endIndex - index - 1), CLUB_EDIT, COMPARISON_TYPE))
                    {
                        track = track.Remove(index, endIndex - index + 1).Trim();
                    }
                                 ...
                                 COMPARISON_TYPE))
                    {
                        ...
                        info.Remixers.AddRange(SplitArtists(remixersText));
                        track = track.Remove(index, endIndex - index + 1).Trim();
                    }
                             ...
                             string.Equals(track.Substring(index + 1, endIndex - index - 1), CLUB_MIX, COMPARISON_TYPE))
                    {
                        track = track.Remove(index, endIndex - index + 1).Trim();
                             ...
                             string.Equals(track.Substring(index + 1, endIndex - index - 1), RADIO_EDIT, COMPARISON_TYPE))
                    {
                        track = track.Remove(index, endIndex - index + 1).Trim();
                    }
                    else if (index + 1 + LIVE_EDIT.Length < track.Length &&
                             string.Equals(track.Substring(index + 1, endIndex - index - 1), LIVE_EDIT, COMPARISON_TYPE))
                    {
                        track = track.Remove(index, endIndex - index + 1).Trim();
                    }
                                 ...
                                 COMPARISON_TYPE))
                    {
                        track = track.Remove(index, endIndex - index + 1).Trim();
                             ...
                             string.Equals(track.Substring(endIndex - I_SAID_IT_AGAIN_REEDIT.Length, I_SAID_IT_AGAIN_REEDIT.Length),
                             ...
                             string.Equals(track.Substring(endIndex - EDIT.Length, EDIT.Length), EDIT, COMPARISON_TYPE))
                    {
                        ...
                        track = track.Remove(index, endIndex - index + 1).Trim();
                             ...
                             string.Equals(track.Substring(index + 1, endIndex - index - 1), ALT_ENDING, COMPARISON_TYPE))
                    {
                        track = track.Remove(index, endIndex - index + 1).Trim();
                    }
                                 ...
                                 EXTENDED_MIX2, COMPARISON_TYPE))
                    {
                        ...
                        track = track.Remove(index, endIndex - index + 1).Trim();
                             ...
                             string.Equals(track.Substring(endIndex - PRETENTIOUS_REMIX.Length, PRETENTIOUS_REMIX.Length),
                                 PRETENTIOUS_REMIX, COMPARISON_TYPE))
                    {
                        ...
                        track = track.Remove(index, endIndex - index + 1).Trim();
                             ...
                             string.Equals(track.Substring(endIndex - MARTIAN_TRAPSTEP_REMIX.Length, MARTIAN_TRAPSTEP_REMIX.Length),
                                 ...
                                 MATILDA_REMIX, COMPARISON_TYPE))
                    {
                        ...
                        track = track.Remove(index, endIndex - index + 1).Trim();
                             ...
                             string.Equals(track.Substring(endIndex - OUTER_EDGES_REMIX.Length, OUTER_EDGES_REMIX.Length),
                                 OUTER_EDGES_REMIX, COMPARISON_TYPE))
                    {
                        ...
                        track = track.Remove(index, endIndex - index + 1).Trim();
                             ...
                             string.Equals(track.Substring(endIndex - THRILLSEEKING_REMIX.Length, THRILLSEEKING_REMIX.Length),
                                 THRILLSEEKING_REMIX, COMPARISON_TYPE))
                    {
                        ...
                        track = track.Remove(index, endIndex - index + 1).Trim();
                             ...
                             string.Equals(track.Substring(endIndex - _2014_REMIX.Length, _2014_REMIX.Length), _2014_REMIX,
                                 COMPARISON_TYPE))
                    {
                                 ...
                                 COMPARISON_TYPE))
                    {
                        ...
                        track = track.Remove(index, endIndex - index + 1).Trim();
                             ...
                             string.Equals(track.Substring(endIndex - DOPEST_DOPE_REMIX.Length, DOPEST_DOPE_REMIX.Length),
                                 DOPEST_DOPE_REMIX, COMPARISON_TYPE))
                    {
                        ...
                        track = track.Remove(index, endIndex - index + 1).Trim();
                             ...
                             string.Equals(track.Substring(endIndex - FEAR_IS_WEAKNESS_REMIX.Length, FEAR_IS_WEAKNESS_REMIX.Length),
                                 ...
                                 COMPARISON_TYPE))
                    {
                        ...
                        track = track.Remove(index, endIndex - index + 1).Trim();
                             ...
                             string.Equals(track.Substring(endIndex - REMIX.Length, REMIX.Length), REMIX, COMPARISON_TYPE))
                    {
        ...
        public static List<string> SplitArtists(string text)
        {
            ...
            for (var i = 0; i < split.Length; i++)
            {
                ...
                if (string.Equals(artist, "Sailor", StringComparison.OrdinalIgnoreCase) &&
                    string.Equals(next, "I", StringComparison.OrdinalIgnoreCase))
                {
                    artists.Add("Sailor & I");
                    i++;
                }
                else if (string.Equals(artist, "J Majik", StringComparison.OrdinalIgnoreCase) &&
                         string.Equals(next, "Wickaman", StringComparison.OrdinalIgnoreCase))
                {
                    artists.Add("J Majik & Wickaman");
                    i++;
                }
                else if (string.Equals(artist, "nothing", StringComparison.OrdinalIgnoreCase) &&
                         string.Equals(next, "nowhere.", StringComparison.OrdinalIgnoreCase))
                {
                    artists.Add("nothing, nowhere.");
                    i++;
                }
                else if (string.Equals(artist, "Camo", StringComparison.OrdinalIgnoreCase) &&
                         string.Equals(next, "Krooked", StringComparison.OrdinalIgnoreCase))
                {
                    artists.Add("Camo & Krooked");
                    i++;
                }
                else if (string.Equals(artist, "Simon", StringComparison.OrdinalIgnoreCase) &&
                         string.Equals(next, "Garfunkel", StringComparison.OrdinalIgnoreCase))
                {
                    artists.Add("Simon & Garfunkel");
                    i++;
                }
                else if (string.Equals(artist, "Jos", StringComparison.OrdinalIgnoreCase) &&
                         string.Equals(next, "Eli", StringComparison.OrdinalIgnoreCase))
                {
                    artists.Add("Jos & Eli");
                    i++;
                }
                else if (string.Equals(artist, "Ost", StringComparison.OrdinalIgnoreCase) &&
                         string.Equals(next, "Kjex", StringComparison.OrdinalIgnoreCase))
                {
                    artists.Add("Ost & Kjex");
                    i++;
                }
                else if (string.Equals(artist, "Suga", StringComparison.OrdinalIgnoreCase) &&
                         string.Equals(next, "Uner", StringComparison.OrdinalIgnoreCase))
                {
                    artists.Add("Suga & Uner");
                    i++;
                }
                else if (string.Equals(artist, "Kraak", StringComparison.OrdinalIgnoreCase) &&
                         string.Equals(next, "Smaak", StringComparison.OrdinalIgnoreCase))
                {
                    artists.Add("Kraak & Smaak");
                    i++;
                }
                else if (string.Equals(artist, "Sidewalks", StringComparison.OrdinalIgnoreCase) &&
                         string.Equals(next, "Skeletons", StringComparison.OrdinalIgnoreCase))
                {
                    artists.Add("Sidewalks and Skeletons");
                    i++;
                }
                else if (string.Equals(artist, "Above", StringComparison.OrdinalIgnoreCase) &&
                         string.Equals(next, "Beyond", StringComparison.OrdinalIgnoreCase))
                {
                    artists.Add("Above & Beyond");
                    i++;
                }
                else if (string.Equals(artist, "Blunts", StringComparison.OrdinalIgnoreCase) &&
                         string.Equals(next, "Blondes", StringComparison.OrdinalIgnoreCase))
                {
                    artists.Add("Blunts & Blondes");
                    i++;
                }
                else if (string.Equals(artist, "Chase", StringComparison.OrdinalIgnoreCase) &&
                         string.Equals(next, "Status", StringComparison.OrdinalIgnoreCase))
                {
                    artists.Add("Chase & Status");
                    i++;
                }
                else if (string.Equals(artist, "aivi", StringComparison.OrdinalIgnoreCase) &&
                         string.Equals(next, "surasshu", StringComparison.OrdinalIgnoreCase))
                {
                    artists.Add("aivi & surasshu");
                    i++;
                }
                else
                {
